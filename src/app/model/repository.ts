...
const suppliersUrl = rootUrl + "suppliers";
const ordersUrl = rootUrl + "orders";
const sessionUrl = rootUrl + "session/";
...
export class Repository {
    ...
    createProduct(prod: Product) {
        let data = {
          ...
          feature: prod.feature, stock: prod.stock,
          minStocklevel: prod.minStocklevel, prchaseStock: prod.purchaseStock,
